  ...
  return (
    <>
      ...
      <ul>
        ...
        <li className={styles.martList}>
          氏名及びメールアドレスについて、アプリ内のイベント企画者と、アプリの開発・運営チームが見ることができます。
        </li>
        <li>個人情報の消し方について</li>
        <li className={styles.martList}>
          アカウントを消すことで24時間以内に情報が削除されます。
        </li>
        <li>利用規約変更時の対応について</li>
        <li className={styles.martList}>
          利用規約に変更を加える場合、規約を実際に変更する１ヶ月前に、登録されたメールアドレス宛にメールで通知します。
          今後の利用規約変更に同意いただけない場合は、退会してください。
        </li>
        <li>お問い合わせ先について</li>
        <li className={styles.martList}>
