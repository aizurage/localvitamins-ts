    ...
    return(
        <>
            ...
            <DateTimeBlock 
                ...
                to={event.period.to} 
            />
            <HeadingDescriptionBlock heading="参加して欲しい人" description={event.target} />
            <HeadingDescriptionBlock heading="お手伝い内容" description={event.content} />
            <HeadingDescriptionBlock heading="持ち物" description={event.belongings} />
            ...
            <HeadingDescriptionBlock heading="お問い合わせ先" description={event.inquiry} />
        </>
    )
}